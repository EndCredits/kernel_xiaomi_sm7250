...
static int z_erofs_cache_releasepage(struct page *page, gfp_t gfp_mask)
{
 ...
 */
static void z_erofs_cache_invalidatepage(struct page *page, unsigned int offset, unsigned int length)
{
...
static const struct address_space_operations z_erofs_cache_aops = {
	.releasepage = z_erofs_cache_releasepage,
	.invalidatepage = z_erofs_cache_invalidatepage,
};
...
repeat:
	...
	if (z_erofs_is_inline_pcluster(fe->pcl)) {
		...
		WRITE_ONCE(fe->pcl->compressed_bvecs[0].page, fe->map.buf.page);
